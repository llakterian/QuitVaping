...
// in quit_vaping/test/mcp_client_service_test.dart.
...
class MockWebSocketChannel extends _i1.Mock implements _i2.WebSocketChannel {
  ...
  @override
  int? get closeCode => (super.noSuchMethod(Invocation.getter(#closeCode))
      as int?);

  @override
  String? get closeReason => (super.noSuchMethod(Invocation.getter(#closeReason))
      as String?);
  ...
  @override
  dynamic get sink => (super.noSuchMethod(Invocation.getter(#sink)));
}