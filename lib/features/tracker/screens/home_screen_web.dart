...
import '../../subscription/widgets/banner_ad_widget_web.dart';
...
class _HomeTab extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return Consumer2<UserService, subscription_service_web.SubscriptionService>(
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                // Banner Ad (only for free users) - Web version
                if (!isPremium) 
                  const Padding(
