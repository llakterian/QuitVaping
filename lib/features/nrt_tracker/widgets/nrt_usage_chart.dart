...
class NRTUsageChart extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (spots.length > 2) {
      ...
      final firstAvg = firstHalf.fold(0.0, (sum, spot) => sum + (spot.y == null ? 0.0 : spot.y as double)) / (firstHalf.isEmpty ? 1 : firstHalf.length);
      final secondAvg = secondHalf.fold(0.0, (sum, spot) => sum + (spot.y == null ? 0.0 : spot.y as double)) / (secondHalf.isEmpty ? 1 : secondHalf.length);
